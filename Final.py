...
if __name__ == "__main__":
    ...
    new = tk.Tk()
    new.title("HTTP Traffic Sniffer")

    text_box = scrolledtext.ScrolledText(new, wrap=tk.WORD, width=80, height=20)
    text_box.pack(padx=10, pady=10)

    start_button = tk.Button(new, text="Start Sniffing", command=lambda: start_sniffing(text_box))
